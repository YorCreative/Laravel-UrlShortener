...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection($this->getConnection())->create('short_url_tracings', function (Blueprint $table) {
    ...
    {
        Schema::connection($this->getConnection())->dropIfExists('short_url_tracings');
    }
};
